...
import TuevService from "../service/tuev.service.js";
import {wrapHandler} from "../utils.js";
import RestifyError from "restify-errors";


export default class TuevController {
    /**
    ...
    async read(req, res, next) {
        ...
        if (result) {
            ...
            throw new RestifyError.NotFoundError("tueve nicht gefunden");
        }
    ...
    async update(req, res, next) {
        ...
        if (result) {
            ...
            throw new RestifyError.NotFoundError("Kennzeichen nicht gefunden");
        }
